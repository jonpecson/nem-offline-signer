...
import { ToastProvider, LoadingProvider, HistoryProvider } from '../../providers/providers';
...
export class SearchPage {
	...
	constructor(private translate: TranslateService, keyboard: Keyboard, fb: FormBuilder, public history: HistoryProvider, private toast: ToastProvider, private loader: LoadingProvider, public appCtrl: App, public alertCtrl: AlertController, public viewCtrl: ViewController, public navCtrl: NavController) {
		this.loader.present();
