...
import { AddressProvider, ToastProvider } from '../../../providers/providers';
...
export class SavedAddressPage {
  ...
  constructor(private toast: ToastProvider, private alertCtrl: AlertController, private translate: TranslateService, private viewCtrl: ViewController, private navParams: NavParams, private address: AddressProvider, public modalCtrl: ModalController) {
